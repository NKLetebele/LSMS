                                                    ...
                                                    <table class="table table-hover">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?= date('jS F, Y', strtotime($department['createDate'])) ?></td>
                                                                ...
                                                                <td>
                                                                    <div class="dropdown-secondary dropdown">
                                                                        <button class="btn btn-primary btn-mini dropdown-toggle waves-effect waves-light" type="button" id="dropdown1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Actions</button>
                                                                        <div class="dropdown-menu" aria-labelledby="dropdown1" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                                                            <a class="dropdown-item waves-light waves-effect" href="staff_list.php?department=<?= urlencode($department['name']) ?>"><i class="ti-user"></i> View Staff</a>
                                                                            <a class="dropdown-item waves-light waves-effect edit-btn md-trigger" href="#" data-modal="modal-13" data-original-title="Edit" data-id="<?= $department['id'] ?>" data-name="<?= $department['name'] ?>" data-description="<?= $department['desc'] ?>"><i class="ti-pencil"></i> Edit</a>
                                                                            <a class="dropdown-item waves-light waves-effect delete-btn" href="#" data-original-title="Delete" data-id="<?= $department['id'] ?>"><i class="ti-trash"></i> Delete</a>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
